...
class TypeMapExpression:
    ...
    def ignore_member(self, name : str) -> 'TypeMapExpression':
        ...
        if configuration is None: self._configuration.member_configurations.append(MemberMapConfiguration(name, True))
    ...
    def for_member(self, name: str, converter : Callable[[MemberMappingContext], Any]):
        ...
        else: configuration.value_converter = converter
        return self
